...
type NewKurtosisAvalancheModuleConfigurator struct{}

func NewNewKurtosisAvalancheModuleConfigurator() *NewKurtosisAvalancheModuleConfigurator {
	return &NewKurtosisAvalancheModuleConfigurator{}
}

func (t NewKurtosisAvalancheModuleConfigurator) ParseParamsAndCreateExecutableModule(serializedCustomParamsStr string) (kurtosis_modules.ExecutableKurtosisModule, error) {
	...
	module := NewAvalancheNetworkModule()
